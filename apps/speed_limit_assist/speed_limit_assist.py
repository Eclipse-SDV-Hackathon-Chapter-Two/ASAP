...
class SpeedLimitAssist:
    def __init__(self, limit, vel_mps):
        self.limit = limit
    ...
    def check_speed_limit(self):
        ...
        if self.vel_mps > 0.0 and self.limit > 0.0:
            ...
            if exceeded_speed > 0.0:
                warning = "You are exceeding the current speed limit= " + str(self.limit*3.6) + " by " + str(exceeded_speed*3.6) +  "km/h"
...
if __name__ == "__main__":
    ...
    speedLimitAssist = SpeedLimitAssist(0.0, 0.0)
